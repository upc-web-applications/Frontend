...
const form = ref({ codigo:'', nombre:'', tipo:'Fisico', descripcion:'', nivelRiesgoBase:'Medio', estado:'Activo' })

const tipoOptions = ['Fisico', 'Quimico', 'Ergonomico', 'Biologico', 'Mecanico', 'Electrico', 'Psicosocial', 'Otro']
const nivelOptions = ['Bajo', 'Medio', 'Alto', 'Critico']
...
const submit = async () => {
    ...
    try {
        ...
        router.push('/risk-assessment/hazard/list')
