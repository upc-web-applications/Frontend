...
<template>
  <div v-if="site">
    <div class="rg-page-header">
      ...
      <pv-button :label="t('common.edit')" icon="pi pi-pencil" size="small" @click="router.push(`/organization-assets/site/${site.id}/edit`)" />
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      ...
      <div class="rg-card">
        ...
        <div v-for="area in areas" :key="area.id" class="rg-detail-row" style="cursor:pointer" @click="router.push(`/organization-assets/area/${area.id}`)">
