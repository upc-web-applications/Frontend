...
import { ref } from 'vue'
import { AreaApi } from '@/organization-assets/area/infrastructure/area-api.js'
...
export const useAreaStore = defineStore('area', () => {
    ...
    function fetchAll() { return api.getAreas().then(r => { areas.value = AreaAssembler.toEntitiesFromResponse(r); loaded.value = true }).catch(e => { errors.value.push(e); return Promise.reject(e) }) }
