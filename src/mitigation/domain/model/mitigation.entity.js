...
export class Mitigation {
    constructor({ id=null, riskAssessmentId=null, ticketId=null, codigo='', descripcion='', responsable='', fechaAsignacion='', fechaEjecucion='', estado='En ejecucion', resultado='', observaciones='' }) {
