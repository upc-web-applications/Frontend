...
export const useHistorialTicketStore = defineStore('historialTicket', () => {
    ...
    function fetchAll() { return api.getAll().then(r => { historiales.value = HistorialTicketAssembler.toEntitiesFromResponse(r); loaded.value = true }).catch(e => { errors.value.push(e); return Promise.reject(e) }) }
