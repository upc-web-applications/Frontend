...
export const useTicketAccionCorrectivaStore = defineStore('ticketAccionCorrectiva', () => {
    ...
    function fetchAll() { return api.getTickets().then(r => { tickets.value = TicketAccionCorrectivaAssembler.toEntitiesFromResponse(r); loaded.value = true }).catch(e => { errors.value.push(e); return Promise.reject(e) }) }
